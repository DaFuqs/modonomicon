...
- [`dcb96b3`](https://github.com/klikli-dev/modonomicon/commit/dcb96b337e4834fb3a6edaf35c58fb3407f1d229) - increase mod version (force new release) *(commit by [@klikli-dev](https://github.com/klikli-dev))*
...
### :bug: Bug Fixes
- [`edf1f5f`](https://github.com/klikli-dev/modonomicon/commit/edf1f5fcd5a27b49611ad28a1bbc89825af2b085) - default zoom multiplier wrong by a factor 512 *(commit by [@klikli-dev](https://github.com/klikli-dev))*
- [`3812f18`](https://github.com/klikli-dev/modonomicon/commit/3812f185982e4abda8ac0e7d7c2017ece5208f82) - store open entry in category properly *(commit by [@klikli-dev](https://github.com/klikli-dev))*
- [`b77e68b`](https://github.com/klikli-dev/modonomicon/commit/b77e68b5f6fbfcb88e71cde00b6c8a68f15157ea) - redirect entry in history prevents opening category *(commit by [@klikli-dev](https://github.com/klikli-dev))*
- [`bd48697`](https://github.com/klikli-dev/modonomicon/commit/bd486979acd370bf6899a12a73ed99fcde8ba32d) - Clicking a category opens up an entry *(commit by [@klikli-dev](https://github.com/klikli-dev))*


## [release/v1.20.1-1.72.2] - 2024-06-08
### :bug: Bug Fixes
- [`9a1ee02`](https://github.com/klikli-dev/modonomicon/commit/9a1ee02b77669bcde0b06a1bef596923d80307e6) - book closes entirely in some cases instead of closing the open entry *(commit by [@klikli-dev](https://github.com/klikli-dev))*
...
## [release/v1.20.1-1.66.5] - 2024-03-31
### :bug: Bug Fixes
- [`ac124fc`](https://github.com/klikli-dev/modonomicon/commit/ac124fc3147a095ce7b233775bcfb24b6dfb762d) - run missing datagen for forge *(commit by [@klikli-dev](https://github.com/klikli-dev))*


## [release/v1.20.1-1.66.4] - 2024-03-31
### :bug: Bug Fixes
- [`077ab13`](https://github.com/klikli-dev/modonomicon/commit/077ab131d9df9eae2a103a921088ee54edb3fe8a) - Added missing lang for condition.mod_loaded ([#193](https://github.com/klikli-dev/modonomicon/pull/193))  - thanks @DaFuqs *(commit by [@DaFuqs](https://github.com/DaFuqs))*
...
## [release/v1.20.1-1.63.0] - 2024-03-27
### :bug: Bug Fixes
- [`d68441f`](https://github.com/klikli-dev/modonomicon/commit/d68441fec32f1b606cdc0f7f6937d4cf72283563) - switch to nbt codec instead of json for book state network sync *(commit by [@klikli-dev](https://github.com/klikli-dev))*
...
## [release/v1.20.1-1.57.0] - 2024-01-25
### :bug: Bug Fixes
- [`cc5dfa8`](https://github.com/klikli-dev/modonomicon/commit/cc5dfa8659cf801ebadc1afee86471bd94244c6b) - CJK character render issues *(commit by [@klikli-dev](https://github.com/klikli-dev))*
...
- [`cf9602b`](https://github.com/klikli-dev/modonomicon/commit/cf9602bafb7271261b895f031743c63408227e06) - change item link default color *(commit by [@klikli-dev](https://github.com/klikli-dev))*
...
## [release/v1.20.1-1.54.1] - 2024-01-13
### :bug: Bug Fixes
- [`074f4aa`](https://github.com/klikli-dev/modonomicon/commit/074f4aab2023c59e02c812ffb43dc8e29d68b339) - protect against scenarios where in SP multiblocks and books get cleared *(commit by [@klikli-dev](https://github.com/klikli-dev))*
...
### :wrench: Chores
- [`c36a463`](https://github.com/klikli-dev/modonomicon/commit/c36a46398c231135d94c96dc3302ca55ed7b7f6c) - set mod version *(commit by [@klikli-dev](https://github.com/klikli-dev))*


## [release/v1.20.1-1.49.1] - 2024-01-09
### :bug: Bug Fixes
- [`4562222`](https://github.com/klikli-dev/modonomicon/commit/45622228e3eef59ef59c0ac35389ca50c20cddc8) - force book update and sync after reload command *(commit by [@klikli-dev](https://github.com/klikli-dev))*
...
## [release/v1.20.1-1.48.0] - 2024-01-08
### :sparkles: New Features
- [`0b2f0de`](https://github.com/klikli-dev/modonomicon/commit/0b2f0dea5a86cdb4d112d6e6908a80877ccc2179) - add text helper to entry provider *(commit by [@klikli-dev](https://github.com/klikli-dev))*


## [release/v1.20.1-1.47.0] - 2024-01-08
### :sparkles: New Features
- [`5ca073e`](https://github.com/klikli-dev/modonomicon/commit/5ca073ef4145ca39edaf965591e2ba046fd2f6a9) - add entry provider *(commit by [@klikli-dev](https://github.com/klikli-dev))*
...
## [release/v1.20.1-1.43.3] - 2023-12-26
### :bug: Bug Fixes
- [`f0536b1`](https://github.com/klikli-dev/modonomicon/commit/f0536b1575589cbc8b8409748e74311c544d91fd) - make book preprender abort if build failed to allow smoother error handling when opening book *(commit by [@klikli-dev](https://github.com/klikli-dev))*


## [release/v1.20.1-1.43.2] - 2023-12-23
### :bug: Bug Fixes
- [`556ca3a`](https://github.com/klikli-dev/modonomicon/commit/556ca3a4c07ac81867a94f850d4e8d11c57ea7e5) - creative tabs for fabric *(commit by [@klikli-dev](https://github.com/klikli-dev))*
...
## [release/v1.20.1-1.42.1] - 2023-12-22
### :bug: Bug Fixes
- [`c36bfd9`](https://github.com/klikli-dev/modonomicon/commit/c36bfd9c8fc26e6d1e51c24116c4fdebbfa9cb0b) - ground layer padding extra rows too short *(commit by [@klikli-dev](https://github.com/klikli-dev))*
