...
public class ModonomiconConstants {
    ...
    public static class Data {
        ...
        public static class EntryType {
            ...
            public static final ResourceLocation ENTRY_LINK = new ResourceLocation(ModonomiconAPI.ID, "entry_link");
        }
        ...
        public static class Condition {
            ...
            public static final ResourceLocation CATEGORY_HAS_ENTRIES = new ResourceLocation(ModonomiconAPI.ID, "category_has_entries");
        }
    }
